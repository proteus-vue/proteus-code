...
export const METHOD_PARAMS: Record<string, readonly string[]> = {
  ...
  "thread/read": ["id", "threadId", "thread_id", "limit"],
  "thread/export": ["id", "format"],
  "thread/goal/get": [],
  "thread/items/list": ["id", "threadId", "thread_id", "limit"],
  "thread/turns/list": ["id", "threadId", "thread_id", "limit"],
  "thread/archive": ["id", "threadId", "thread_id"],
  "thread/unarchive": ["id", "threadId", "thread_id"],
  "thread/loaded/list": [],
  "tools/list": [],
  "models/list": [],
  "model/list": [],
...
export type ThreadIdParams = { id: string, };
export type ThreadReadParams = { id: string, };
